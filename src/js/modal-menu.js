...
const gallery = document.querySelector('.results'); // плюс название
...
//   const halfStar = rating % 1 !== 0 ? '<span
//class="star">&#9733;</span>' : '';
//   const emptyStarsCount = Math.max(0, 5 - Math.ceil(rating)); //
