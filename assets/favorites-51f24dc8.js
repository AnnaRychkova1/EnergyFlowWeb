import{i as c,r as g}from"./modal-menu-444a5033.js";import{refs as e}from"./refs-89afcfb6.js";import y from"./scrollFavorites-579ce649.js";import{showLoader as d,show as p,hide as b,hideLoader as n}from"./visibility-9f0213da.js";import{errorResult as f}from"./iziToast-49d9e9dd.js";import"./vendor-fd853f38.js";const M=localStorage.getItem("favorites"),s=JSON.parse(M);$();async function $(){d(e.loaderModal);try{if(!Array.isArray(s)||s.length===0){p(e.favoritesMessage);return}e.favoritesMessage&&b(e.favoritesMessage),e.favoritesGallery.innerHTML="",k(s),y()}catch{f("Error creating favorites gallery")}finally{n(e.loaderModal)}}function k(o){const l=o.map(({_id:t,bodyPart:r,name:v,target:u,burnedCalories:m,time:h})=>`
...
//# sourceMappingURL=favorites-51f24dc8.js.map
