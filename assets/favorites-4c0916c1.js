import"./vendor-0f51b997.js";import{s as c}from"./mainApi-a350fbdd.js";import{hide as f,show as v}from"./visibility-9f0213da.js";import{refs as a}from"./refs-78569e0c.js";const m=JSON.parse(localStorage.getItem("quoteResponse"));console.log(m);d();a.addToFavoritesBtn.addEventListener("click",g);async function g(o){o.preventDefault();const s=o.target.closest(".ex-add-btn"),e=s.dataset.id,i=localStorage.getItem("favorites");if(i){const r=JSON.parse(i);if(r.some(({_id:t})=>t===e))localStorage.setItem("favorites",JSON.stringify(r.filter(({_id:t})=>t!==e))),s.innerHTML=addInnerHTML();else{const t=await c(e);localStorage.setItem("favorites",JSON.stringify([...r,t])),s.innerHTML=addInnerHTML("remove")}}}async function d(o){if(a.favoritesGallery.innerHTML="",f(a.favoritesMessage),!localStorage.getItem("favorites")){v(a.favoritesMessage);return}try{const e=await JSON.parse(localStorage.getItem("favorites"));if(a.favoritesGallery.insertAdjacentHTML("afterbegin",p()),e>=9)u();else return}catch(e){console.error(e)}finally{console.log(),a.favoritesGallery.reset()}}function p({_id:o,bodyPart:s,name:e,target:i,burnedCalories:r,time:l}){const t=localStorage.getItem("favorites");return t&&JSON.parse(t).some(n=>n._id===o),`
...
//# sourceMappingURL=favorites-4c0916c1.js.map
