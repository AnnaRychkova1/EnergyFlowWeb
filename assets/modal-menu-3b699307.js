import{a as k}from"./vendor-8cce9181.js";import{show as S}from"./visibility-9f0213da.js";const h="/EnergyFlowWeb/assets/symbol-defs-e37f3f88.svg";document.querySelector(".results");const v=document.querySelector(".backdrop"),g=document.querySelector(".modal");let l;async function F(e){S(v),l=e;try{let r=function(i){const c=i.target.dataset.id||l,d=document.querySelector(".exercise-name").textContent,n=document.querySelector(".exercise-information .ex-block:nth-child(1).exercise-label").textContent,u=document.querySelector(".exercise-information .ex-block:nth-child(2).exercise-label").textContent,x=document.querySelector(".exercise-information .ex-block:nth-child(3).exercise-label").textContent,m=document.querySelector(".exercise-information .ex-block:nth-child(4).exercise-label").textContent,p=document.querySelector(".exercise-information .ex-block:nth-child(5).exercise-label").textContent,y=document.querySelector(".exercise-gif img").src;let s=JSON.parse(localStorage.getItem("exerciseFavorites"))||[];const f=s.some(o=>o._id===c);if(f?i.target.textContent="Add to favorites":i.target.textContent="Remove from favorites",f)s=s.filter(o=>o._id!==c),localStorage.setItem("exerciseFavorites",JSON.stringify(s));else{const o={_id:c,name:d,bodyPart:n,equipment:u,time:x,target:m,burnedCalories:p,gifUrl:y};s.push(o),localStorage.setItem("exerciseFavorites",JSON.stringify(s))}};const t=await $(l);console.log(t),q(t),console.log(l),document.querySelector(".ex-add-favorite").addEventListener("click",r)}catch(t){console.error("Error fetching images:",t)}}async function $(e){console.log(e);try{const t="https://energyflow.b.goit.study/api",a="exercises",{data:r}=await k.get(`${t}/${a}/${e}`);return r}catch(t){console.error(t)}}function q({_id:e,bodyPart:t,equipment:a,time:r,target:i,burnedCalories:c,gifUrl:d,name:n,popularity:u,rating:x,description:m}){const p=`<div class="modal-container">
...
//# sourceMappingURL=modal-menu-3b699307.js.map
