import"./vendor-65c0bc71.js";import{s as c}from"./mainApi-08a8f4dc.js";import{hide as f,show as v}from"./visibility-9f0213da.js";import{refs as a}from"./refs-057c7077.js";import"./isiToast-262f9325.js";const m=JSON.parse(localStorage.getItem("quoteResponse"));console.log(m);p();a.addToFavoritesBtn.addEventListener("click",g);async function g(o){o.preventDefault();const s=o.target.closest(".ex-add-btn"),e=s.dataset.id,i=localStorage.getItem("favorites");if(i){const r=JSON.parse(i);if(r.some(({_id:t})=>t===e))localStorage.setItem("favorites",JSON.stringify(r.filter(({_id:t})=>t!==e))),s.innerHTML=addInnerHTML();else{const t=await c();localStorage.setItem("favorites",JSON.stringify([...r,t])),s.innerHTML=addInnerHTML("remove")}}}async function p(o){if(a.favoritesGallery.innerHTML="",f(a.favoritesMessage),!localStorage.getItem("favorites")){v(a.favoritesMessage);return}try{const e=await JSON.parse(localStorage.getItem("favorites"));if(a.favoritesGallery.insertAdjacentHTML("afterbegin",d()),e>=9)u();else return}catch(e){console.error(e)}finally{console.log(),a.favoritesGallery.reset()}}function d({_id:o,bodyPart:s,name:e,target:i,burnedCalories:r,time:l}){const t=localStorage.getItem("favorites");return t&&JSON.parse(t).some(n=>n._id===o),`
...
//# sourceMappingURL=favorites-3e446624.js.map
